        ...
        <div className="w-full md:w-64 shrink-0 space-y-1">
          {[
            ...
            { id: 'security', label: 'Security', icon: ShieldAlert },
             ...
             <button key={tab.id} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all ${tab.active ? 'bg-primary-light text-primary-text' : 'text-gray-600 hover:bg-gray-100'}`}>
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
          ...
          <div className="space-y-6 max-w-2xl">
            <div>
              ...
              <input type="text" defaultValue="RukunPOS" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-medium" />
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1.5">Currency Symbol</label>
                <input type="text" defaultValue="$" className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-medium" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1.5">Currency Position</label>
                <select className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all font-medium appearance-none">
                  <option>Left</option>
                  <option>Right</option>
                </select>
              </div>
            ...
            <div className="pt-6 border-t border-gray-100 flex justify-end">
              <Button className="bg-primary hover:bg-primary-dark text-white rounded-xl h-11 px-8 font-bold flex items-center gap-2">
