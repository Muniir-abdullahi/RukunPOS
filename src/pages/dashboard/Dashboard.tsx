    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <Card className="xl:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link to="/sales" className="text-sm font-medium text-primary-600 hover:text-primary-700 flex items-center">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Link to="/reports/stock" className="text-sm font-medium text-primary-600 hover:text-primary-700 flex items-center">
