        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/system-design" className="text-base text-gray-500 hover:text-primary-600 transition-colors">System Design</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/dashboard" className="text-base text-gray-500 hover:text-primary-600 transition-colors">Inventory</Link></li>
              <li><Link to="/dashboard" className="text-base text-gray-500 hover:text-primary-600 transition-colors">Accounting</Link></li>
            </ul>
          </div>
